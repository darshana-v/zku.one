...
contract Ballot {
    ...
    // Proposal is the type of a single proposal.
    struct Proposal {
    ...
    // storing `Voter` struct for each possible address.
    ...
    /// Creating new ballot to choose one of `proposalNames`.
    constructor(bytes32[] memory proposalNames) {
        ...
        // Appending a new proposal object for each of provided proposal names to the end of the array.
    ...
    function giveRightToVote(address voter) external {
        ...
        // to `false`, execution terminates and all changes to the state and to Ether balances are reverted.
        // Using `require` to check if functions are called correctly.
        require(
